...
**Tier 2 — V1 quality**
- [ ] **Fix the long-task block-thrashing bug** (own branch; root-cause first — likely block keep-alive/strategy config; `long_task_via_handle` + `long_job_30m` are the validation)

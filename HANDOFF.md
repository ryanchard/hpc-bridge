...
- **Tier 3** (release engineering) — DONE to beta (2026-09-04): marketplace packaging (#52/#74), security review (#75–#79, vault `Reference/Security review 2026-09-04.md`), CHANGELOG.md, version 0.1.1 / tag `v0.1.1-beta.1`. Remaining: org transfer (after Ryan) + the production registry index in the same release.
